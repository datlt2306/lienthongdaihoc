...
<section class="bg-white rounded-lg shadow-sm border border-slate-100 p-6">
	...
	<div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
		<a href="tel:<?php echo esc_attr( preg_replace( '/\D/', '', $hotline ) ); ?>"
		   class="flex flex-col items-center gap-1.5 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded-lg p-4 transition-all group">
		...
		<a href="<?php echo esc_url( $zalo ); ?>" target="_blank" rel="noopener"
		   class="flex flex-col items-center gap-1.5 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg p-4 transition-all group">
			<span class="text-2xl">💬</span>
		...
		<a href="<?php echo esc_url( $messenger ); ?>" target="_blank" rel="noopener"
		   class="flex flex-col items-center gap-1.5 bg-sky-50 hover:bg-sky-100 border border-sky-200 rounded-lg p-4 transition-all group">
			<span class="text-2xl">💌</span>
