				...
				<div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
					...
					<div class="p-8 md:p-10">
						...
						<div class="mt-8 pt-6 border-t border-slate-100">
							<p class="text-xs font-extrabold text-slate-400 uppercase tracking-wider mb-3">Chia sẻ bài viết</p>
							<div class="flex gap-2">
								<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode( get_permalink() ); ?>" target="_blank" rel="noopener"
								   class="flex items-center gap-2 px-4 py-2 bg-[#1877F2] text-white text-xs font-bold rounded-lg hover:bg-[#166FE5] transition-all">
								...
								<a href="https://zalo.me/share/url?url=<?php echo urlencode( get_permalink() ); ?>" target="_blank" rel="noopener"
								   class="flex items-center gap-2 px-4 py-2 bg-[#0068FF] text-white text-xs font-bold rounded-lg hover:opacity-90 transition-all">
									💬 Zalo
								</a>
								<button onclick="navigator.clipboard.writeText('<?php echo esc_js( get_permalink() ); ?>'); this.textContent='✓ Đã sao chép';"
								        class="flex items-center gap-2 px-4 py-2 bg-slate-100 text-slate-700 text-xs font-bold rounded-lg hover:bg-slate-200 transition-all">
									🔗 Sao chép link
								</button>
							</div>
						</div>
