...
<main id="primary" class="site-main py-12 bg-slate-50">
	<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div class="space-y-4">
			...
			// Fallback to hardcoded if ACF not populated.
			if ( empty( $faq_items ) ) {
				$faq_items = [
					...
					[ 'question' => 'Bằng đại học liên thông/văn bằng 2 có đủ điều kiện thi cao học không?', 'answer' => 'Hoàn toàn đủ điều kiện. Tấm bằng tốt nghiệp do các đại học liên kết cấp có đầy đủ giá trị pháp lý để bạn đăng ký thi thạc sĩ, cao học, thi công chức nhà nước hoặc nâng bậc lương.' ],
