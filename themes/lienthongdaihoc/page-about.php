	...
	<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<article class="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200 space-y-6">
			...
			<div class="prose prose-slate max-w-none text-slate-600 text-base leading-relaxed space-y-4">
				<p class="font-semibold text-slate-800">lienthongdaihoc.com là cổng thông tin tìm kiếm, đối chiếu và tư vấn tuyển sinh đại học trực tuyến liên thông, văn bằng 2 và đào tạo từ xa hàng đầu tại Việt Nam.</p>
				<p>Sứ mệnh của chúng tôi là trở thành cầu nối tin cậy giữa người học và các trường Đại học danh tiếng, mang lại cơ hội tiếp cận tri thức đại học dễ dàng, linh hoạt và tối ưu hóa chi phí cho người đi làm.</p>
				<p>Hệ thống hỗ trợ tổng hợp thông tin học phí, điều kiện xét tuyển, hồ sơ chuẩn bị của hàng trăm lớp học trực tuyến chính quy, hỗ trợ sinh viên nhanh chóng tìm được lớp học thích hợp nhất.</p>
			</div>
